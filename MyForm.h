...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(453, 76);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Ola mundooooooo";
			this->label1->Click += gcnew System::EventHandler(this, &MyForm::label1_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(226, 73);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(552, 65);
...
#pragma endregion
	private: System::Void label1_Click(System::Object^ sender, System::EventArgs^ e) {
		this->label1->Text = "Te amo";
	}
	private: System::Void textBox1_Click(System::Object^ sender, System::EventArgs^ e) {

		this->textBox1->Text = "Bloquaedo";
	}
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		MessageBox::Show("Parado é um assalto!!", "Botão", MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
	}
};
}
